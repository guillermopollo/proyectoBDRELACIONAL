...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prenda` (
  `tipoprenda` varchar(25) DEFAULT NULL,
  `talla` varchar(2) DEFAULT NULL,
  `codigo` varchar(25) DEFAULT NULL,
  `dni_persona` varchar(25) DEFAULT NULL,
  KEY `dni_persona` (`dni_persona`),
  CONSTRAINT `prenda_ibfk_1` FOREIGN KEY (`dni_persona`) REFERENCES `persona` (`dni`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-04 20:03:40
